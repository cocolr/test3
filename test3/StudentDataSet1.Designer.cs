...
namespace test3 {
    ...
    public partial class StudentDataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public StudentRow AddStudentRow(string sno, string sname, string sex, System.DateTime birthtime, string state, string cno) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public System.DateTime birthtime {
                get {
                    try {
                        return ((global::System.DateTime)(this[this.tableStudent.birthtimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("表“Student”中列“birthtime”的值为 DBNull。", e);
                    }
                }
                set {
                    this[this.tableStudent.birthtimeColumn] = value;
                }
            }
            ...
            public bool IsbirthtimeNull() {
                return this.IsNull(this.tableStudent.birthtimeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetbirthtimeNull() {
                this[this.tableStudent.birthtimeColumn] = global::System.Convert.DBNull;
            }
            ...
            public bool IscnoNull() {
                return this.IsNull(this.tableStudent.cnoColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetcnoNull() {
                this[this.tableStudent.cnoColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace test3.StudentDataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([sno] = @Original_sno) AND ((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_birthtime = 1 AND [birthtime] IS NULL) OR ([birthtime] = @Original_birthtime)) AND ((@IsNull_state = 1 AND [state] IS NULL) OR ([state] = @Original_state)) AND ((@IsNull_cno = 1 AND [cno] IS NULL) OR ([cno] = @Original_cno)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_birthtime", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_birthtime", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_cno", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "cno", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Student] ([sno], [sname], [sex], [birthtime], [state], [cno]) " +
                "VALUES (@sno, @sname, @sex, @birthtime, @state, @cno);\r\nSELECT sno, sname, sex, " +
                "birthtime, state, cno FROM Student WHERE (sno = @sno)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@birthtime", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [sno] = @sno, [sname] = @sname, [sex] = @sex, [birthtime] = @birthtime, [state] = @state, [cno] = @cno WHERE (([sno] = @Original_sno) AND ((@IsNull_sname = 1 AND [sname] IS NULL) OR ([sname] = @Original_sname)) AND ((@IsNull_sex = 1 AND [sex] IS NULL) OR ([sex] = @Original_sex)) AND ((@IsNull_birthtime = 1 AND [birthtime] IS NULL) OR ([birthtime] = @Original_birthtime)) AND ((@IsNull_state = 1 AND [state] IS NULL) OR ([state] = @Original_state)) AND ((@IsNull_cno = 1 AND [cno] IS NULL) OR ([cno] = @Original_cno)));
SELECT sno, sname, sex, birthtime, state, cno FROM Student WHERE (sno = @sno)";
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@birthtime", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cno", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "cno", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@IsNull_birthtime", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Original, true, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_birthtime", global::System.Data.SqlDbType.DateTime, 0, global::System.Data.ParameterDirection.Input, 0, 0, "birthtime", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_cno", global::System.Data.SqlDbType.NChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "cno", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::test3.Properties.Settings.Default.StudentConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT sno, sname, sex, birthtime, state, cno FROM dbo.Student";
        ...
        public virtual int Delete(string Original_sno, string Original_sname, string Original_sex, global::System.Nullable<global::System.DateTime> Original_birthtime, string Original_state, string Original_cno) {
            ...
            if ((Original_birthtime.HasValue == true)) {
                this.Adapter.DeleteCommand.Parameters[5].Value = ((object)(0));
                this.Adapter.DeleteCommand.Parameters[6].Value = ((System.DateTime)(Original_birthtime.Value));
            }
            else {
            ...
            if ((Original_cno == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((string)(Original_cno));
            }
        ...
        public virtual int Insert(string sno, string sname, string sex, global::System.Nullable<global::System.DateTime> birthtime, string state, string cno) {
            if ((sno == null)) {
            ...
            if ((birthtime.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[3].Value = ((System.DateTime)(birthtime.Value));
            }
            else {
            ...
            if ((cno == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[5].Value = ((string)(cno));
            }
        ...
        public virtual int Update(string sno, string sname, string sex, global::System.Nullable<global::System.DateTime> birthtime, string state, string cno, string Original_sno, string Original_sname, string Original_sex, global::System.Nullable<global::System.DateTime> Original_birthtime, string Original_state, string Original_cno) {
            if ((sno == null)) {
                throw new global::System.ArgumentNullException("sno");
            }
            else {
            ...
            if ((birthtime.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[3].Value = ((System.DateTime)(birthtime.Value));
            }
            else {
            ...
            if ((cno == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[5].Value = ((string)(cno));
            }
            if ((Original_sno == null)) {
                throw new global::System.ArgumentNullException("Original_sno");
            }
            ...
            if ((Original_birthtime.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((System.DateTime)(Original_birthtime.Value));
            }
            else {
            ...
            if ((Original_cno == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[16].Value = ((string)(Original_cno));
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string sname, string sex, global::System.Nullable<global::System.DateTime> birthtime, string state, string cno, string Original_sno, string Original_sname, string Original_sex, global::System.Nullable<global::System.DateTime> Original_birthtime, string Original_state, string Original_cno) {
            return this.Update(Original_sno, sname, sex, birthtime, state, cno, Original_sno, Original_sname, Original_sex, Original_birthtime, Original_state, Original_cno);
        }
    }
